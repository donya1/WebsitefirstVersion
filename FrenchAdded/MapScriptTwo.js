 ...
 "english":
	 {
	   ...
	   "capTitle1":"NEO-VAGRANCY OFFENCES BY TYPE ACROSS CANADA:",
	   "capDes":"Neo-vagrancy offences are mapped across Canada according to offence type. Use menu and legend on top left corner to filter types, and view location and by-law(s) that contain offence.",
 ...
 "french":
	  {
	   ...
	   "capTitle1":"INFRACTIONS RELATIVES AU NÉO-VAGABONDAGE PAR TYPE D'INFRACTION À TRAVERS LE CANADA:",
	   "capDes":"Les infractions de néo-vagabondage sont cartographiées à travers le Canada selon le type d'infraction. Utilisez le menu et la légende dans le coin supérieur gauche pour filtrer les types d'infractions, et afficher le lieu et le(s) règlement(s) qui établissent l'infraction.",
