 ...
 "english":
	 {
	   ...
	   "capTitle1":"NEO-VAGRANCY BY-LAWS ACROSS CANADA: ",
	   "capDes":"The number and location of by-laws that contain a neo-vagrancy offence(s) are mapped. Zoom in and out to explore location, by-law and offences. In addition, two provincial laws are included/counted as one point, with each one having the offence type of ‘panhandling’.",
	   ...
	   "sub2":"75% of Canadians live in a jurisdiction with a Neo-Vagrancy offence.", 
 ...
 "french":
	  {
	   ...
	   "capTitle1":"Règlements sur le nouveau néo-vagabondage à travers le canada: ",
	   "capDes":"Le nombre et l'emplacement des règlements qui contiennent une ou plusieurs infractions relatives au nouveau vagabondage sont cartographiés. Faites un zoom avant et arrière pour explorer l'emplacement, le règlement et les infractions. Par ailleurs, deux lois provinciales sont constituent/comptent comme un seul point, chacune ayant le type d'infraction 'mendicité'.",
